...
(define report-expval-extractor-error
  (lambda (type val)
    (cond
      ...
      ((eq? type 'ref) (eopl:error 'expval->ref "expect reference, but reveived ~s" val))
      (else (eopl:error 'expval->any "expect list or num or bool or proc, but reveived ~s" val)))))
